    ...
    <div className="mt-10">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {nextFiveDays.map((forecast) => (
          <div
            key={forecast.dt}
            className="bg-[#5e82f4] w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] xl:w-[calc(20%-19.2px)] p-6 rounded-2xl shadow-md flex flex-col items-center text-center text-white transition hover:scale-[1.02]"
          >
